...
//        add( btnQuick3 = new QuickslotTool( 83, 53, 22, 25, true ) );
//        add( btnQuick4 = new QuickslotTool( 83, 76, 22, 25, true ) );
//        add( btnQuick5 = new QuickslotTool( 83, 93, 22, 25, true ) );
...
//        btnQuick2.setPos(width - btnQuick1.width(), btnQuick1.height() + btnQuick1.height());
//        btnQuick3.setPos(width - btnQuick1.width(), btnQuick2.height() + btnQuick2.height());
//        btnQuick4.setPos(width - btnQuick1.width(), btnQuick3.height() + btnQuick3.height());
//        btnQuick5.setPos(width - btnQuick1.width(), btnQuick4.height() + btnQuick4.height());
	...
	public static void secondQuickslot( boolean value ) {
		instance.btnQuick2.visible = instance.btnQuick2.active = value;
		instance.layout();
	}
